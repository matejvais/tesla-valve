...
def solve_stokes_mixed(ngmsh, orientation=1, inlet_velocity_coef=0.1, viscosity=10, name="output"):
    '''
    ...
    p_ = Constant(2.0)  # Newtonian fluid
    ...
    VTKFile(f"results-stokes/{name}.pvd").write(u, p, S)
